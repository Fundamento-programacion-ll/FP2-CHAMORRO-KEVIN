...
public class Loguin extends javax.swing.JInternalFrame {
    ControladorEquipo cu= new ControladorEquipo();
    public char permiso;
    ...
    private void autenticar() {
        Usuario usuario;
        usuario = cu.AutenticarUsuario(txt_usuario.getText(), new String(jpw_clave.getPassword()));

        if (usuario != null && usuario.getPermiso() == 'u') { //cliente
