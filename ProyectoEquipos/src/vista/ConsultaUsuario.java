...
public class ConsultaUsuario extends javax.swing.JInternalFrame {
    ...
    public void cargarTabla(){
        ...
        List<Usuario> usuarios =cu.ListarUsuario();
    ...
    public void Busqueda(){
        ...
        limpiarTabla();
            ...
            if(rdb_id.isSelected()==true){
                Usuario u = cu.BuscarUsuarioId(Integer.parseInt(txt_busqueda.getText()));
                fila.add(u.getId());
                fila.add(u.getUsuario());
                fila.add(u.getClave());
                fila.add(u.getPermiso());
            ...
            if(rdb_usu.isSelected()==true){
                Usuario u = cu.BuscarUsuarioUsu(txt_busqueda.getText());
                fila.add(u.getId());
                fila.add(u.getUsuario());
                fila.add(u.getClave());
                fila.add(u.getPermiso());
            ...
            if(rdb_nombre.isSelected()==true){
                Usuario u = cu.BuscarUsuarioNombre(txt_busqueda.getText());
                fila.add(u.getId());
                fila.add(u.getUsuario());
                fila.add(u.getClave());
                fila.add(u.getPermiso());
